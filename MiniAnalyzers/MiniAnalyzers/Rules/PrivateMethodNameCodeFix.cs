...
namespace MiniAnalyzers.Rules
{
    ...
    public class PrivateMethodNameCodeFix : CodeFixProvider
    {
        public const string DiagnosticId = PrivateMethodNameAnalyzer.DiagnosticId;

        private const string title = "Replace first letter with lowercase";
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            context.RegisterCodeFix(
                CodeAction.Create(
                    ...
                    equivalenceKey: nameof(PrivateMethodNameCodeFix)),
        ...
        private async Task<Solution> renameMethod(Solution solution, MethodDeclarationSyntax methodDeclaration, CancellationToken c)
        {
            ...
            var newName = symbol.Name.FirstCharacterToLower();
